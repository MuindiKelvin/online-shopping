...
<h3>Bella Collections Shopping Portal</h3>
            </a>
        </div><!-- /.logo -->
     ...
     <div class="module-body m-t-20">
        <p class="about-us">Committed to deliver 5 star services to our customers</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+254) 100000000001<br>(+254) 700000000002</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@bellacollections.co.ke</a></span>
                </div>
            </li>
